...
(function () {
  ...
  style.textContent = [
    ...
    '#rosaAdminGate{position:fixed;inset:0;z-index:99999;overflow-y:auto;-webkit-overflow-scrolling:touch;background:#F7F0E6;font-family:"Jost",sans-serif;padding:40px 14px}',
    '#rosaAdminGate .rag-card{margin:0 auto;width:100%;max-width:380px;background:#fff;border:1px solid #EDE4D6;border-radius:18px;padding:34px 26px;box-shadow:0 18px 45px rgba(58,50,40,.14);text-align:center}',
